...
const Register = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-5xl overflow-hidden rounded-3xl border border-slate-200 bg-white/90 shadow-[0_35px_80px_-45px_rgba(15,23,42,0.7)] backdrop-blur">
        <div className="grid lg:grid-cols-2">
          <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-gradient-to-br from-teal-900 via-slate-900 to-slate-800 p-10 text-white">
            <div className="absolute -top-20 -right-20 h-48 w-48 rounded-full bg-teal-300/20 blur-3xl" />
            <div className="absolute -bottom-16 left-6 h-40 w-40 rounded-full bg-cyan-300/20 blur-3xl" />
            <div className="relative">
              <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/20 px-3 py-1 text-xs font-semibold">
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-300 pulse-glow"></span>
                Built for fast teams
              </div>
              <h1 className="text-3xl font-black leading-tight">Start your expense system in under a minute.</h1>
              <p className="mt-3 text-sm text-slate-200">
                Create books, invite teammates, and control spending with modern analytics.
              </p>
            </div>
            <div className="relative space-y-3 text-sm text-slate-100">
              <p className="font-semibold">Why teams choose this app</p>
              <p>Simple onboarding</p>
              <p>Powerful real-time collaboration</p>
              <p>Clear audit-ready transaction history</p>
            </div>
          </div>

    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-5xl overflow-hidden rounded-3xl border border-slate-200 bg-white/90 shadow-[0_35px_80px_-45px_rgba(15,23,42,0.7)] backdrop-blur">
        <div className="grid lg:grid-cols-2">
          <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900 p-10 text-white">
            ...
            <div className="relative">
              <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/20 px-3 py-1 text-xs font-semibold">
                ...
                Modern Expense Workspace
              </div>
              <h1 className="text-3xl font-black leading-tight">Track spending with clarity, speed, and control.</h1>
              <p className="mt-3 text-sm text-slate-200">
                Your books, members, and transactions in one polished dashboard.
              </p>
            </div>
            <div className="relative space-y-3 text-sm text-slate-100">
              <p className="font-semibold">What you get</p>
              <p>Live book summaries</p>
              <p>Role-based collaboration</p>
              <p>Clear income vs expense analytics</p>
            </div>
          </div>
